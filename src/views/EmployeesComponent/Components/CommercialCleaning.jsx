...
export default function CommercialCleaning() {
  ...
  const validateForm = () => {
    const newErrors = {};
    if (selectedAreaIndex === '') newErrors.area = 'Please select a commercial lane.';
  ...
  const [state, submitAction, isPending] = useActionState(async prevState => {
    ...
    const commercialCleaning = {
      ...
      ward_no: selectedArea.ward, // same key as ConservancyReport
  ...
  return (
    <>
      <div className="container-fluid my-4">
        <h1 className="mb-3">Commercial Cleaning Report</h1>
        ...
        <form action={submitAction}>
          <div className="row">
            ...
            <div className="col-md-6 mb-4">
              <label htmlFor="commerciallane" className="mb-2 ms-1">Commercial Lane</label>
              <select
                id="commerciallane"
              ...
              >
                <option value="" disabled>Select Commercial Lane</option>
            ...
            <div className="col-md-6 mb-4">
              ...
              <input
                type="number"
                id="sweeper_present"
                className={`form-control ${errors.sweeper ? 'is-invalid' : ''}`}
                placeholder="No. of Sweepers Present"
                value={sweeperCount}
            ...
            <div className="col-md-6 mb-4 d-flex align-items-center">
              <label className="me-3">Commercial Lane Clean?</label>
